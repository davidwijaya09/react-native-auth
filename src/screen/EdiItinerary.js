...
export default function EditItinerary({ navigation, props }) {
    ...
    const goBack = () => {
        navigation.navigate('Itinerary'); // Navigate back to the "Destination" screen
    };
            ...
            <View style={styles.container}>
                ...
                >
                    <View style={{ flex: 1, alignItems: "center" }}>
                        <Text style={styles.textHeader}>Edit Itinerary</Text>
